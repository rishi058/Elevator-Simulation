...
import { useMultiElevatorStore, type MultiElevatorStatus} from '../store/elevatorStore';
...
export const useMultiElevatorWebSocket = () => {
  ...
  const updateMultiElevatorStatus = useMultiElevatorStore((state) => state.updateMultiElevatorStatus);
...
//-------------------------------------------------------------------------------------------------
  const connect = useCallback(() => {
    ...
    try {
      ...
      ws.onmessage = (event) => {
        try {
          const data: MultiElevatorStatus = JSON.parse(event.data);
          console.log('[WebSocket] Received:', data);
          
          updateMultiElevatorStatus(data);
